...
export class LocationService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public locationLocationsLocationIdPut(locationId: string, body?: LocationEditRequest, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public locationLocationsLocationIdPut(locationId: string, body?: LocationEditRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public locationLocationsLocationIdPut(locationId: string, body?: LocationEditRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public locationLocationsLocationIdPut(locationId: string, body?: LocationEditRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (locationId === null || locationId === undefined) {
            throw new Error('Required parameter locationId was null or undefined when calling locationLocationsLocationIdPut.');
        }
        ...
        return this.httpClient.request<any>('put',`${this.basePath}/Location/Locations/${encodeURIComponent(String(locationId))}`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
