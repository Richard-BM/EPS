...
export class AppointmentComponent implements OnInit {
  ...
  private createAppointmentDisplayObject(appointmentResponse: AppointmentResponse) {
    let displayAppointment: DisplayAppointment = {
      ...
      workerName: appointmentResponse.personResponse?.firstname + ", " + appointmentResponse.personResponse?.lastname,
      locationName: appointmentResponse.locationResponse?.name,
      street: appointmentResponse.locationResponse?.street,
      postalcode: appointmentResponse.locationResponse?.postalcode,
      city: appointmentResponse.locationResponse?.city,
