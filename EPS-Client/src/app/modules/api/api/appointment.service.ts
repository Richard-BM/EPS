...
export class AppointmentService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public appointmentAppointmentsGet(observe?: 'body', reportProgress?: boolean): Observable<Array<AppointmentResponse>>;
    public appointmentAppointmentsGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<AppointmentResponse>>>;
    public appointmentAppointmentsGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<AppointmentResponse>>>;
    public appointmentAppointmentsGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<AppointmentResponse>>('get',`${this.basePath}/Appointment/Appointments`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
